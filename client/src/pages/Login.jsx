    ...
    return (
        <div className="max-w-md mx-auto mt-20 bg-white p-8 rounded-xl shadow-lg border border-gray-100">
            <div className="text-center mb-8">
                ...
                <p className="text-gray-500">Sign in to your EveSphere account</p>
            </div>

            {error && <div className="bg-red-50 text-red-600 p-3 rounded-lg mb-6 text-center shadow-inner border border-red-100">{error}</div>}
            {location.state?.message && <div className="bg-green-50 text-green-700 p-3 rounded-lg mb-6 text-center border border-green-100">{location.state.message}</div>}
                    ...
                    <>
                        ...
                        <div>
                            ...
                            <div className="text-right mt-2">
                                <Link to="/forgot-password" className="text-sm font-semibold text-gray-700 hover:text-black hover:underline">
                                    Forgot password?
                                </Link>
                            </div>
                        </div>
