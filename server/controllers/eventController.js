...
exports.createEvent = async (req, res) => {
  ...
  try {
    // Ensure availableSeats defaults to totalSeats when not provided
    const seats = typeof availableSeats !== 'undefined' ? availableSeats : totalSeats;

    // createdBy should come from the authenticated user (set by protect middleware)
